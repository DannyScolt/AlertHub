...
| Auto-escalated alert có thể được tìm qua Backlog 5 `GET /alerts?search=auto_escalated` | Hoàn thành |
...
| Search auto-escalated alert | Query `/alerts?search=auto_escalated&severity=critical` thấy alert critical sinh tự động |
